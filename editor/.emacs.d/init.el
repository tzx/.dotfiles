...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (projectile yasnippet-snippets yasnippet lsp-ui flycheck latex-preview-pane try auctex counsel lsp-python-ms company-lsp company vterm doom-modeline dashboard evil which-key use-package))))
(custom-set-faces
